...
const handleSelectPlan = (plan) => {
  if (!user) {
    alert("กรุณาเข้าสู่ระบบหรือสมัครสมาชิกก่อนใช้งานแพ็กเกจ");
    onLoginClick();
    return;
  }
  ...
  if (planRank[currentPlan] > planRank[plan.key]) {
    alert(`แพ็กเกจ ${currentPlan.toUpperCase()} สามารถใช้งานสิทธิ์ของแพ็กเกจ ${plan.title} ได้อยู่แล้ว`);
    return;
  }

  if (plan.key === "basic") {
    alert("คุณใช้งานแพ็กเกจ Basic ฟรีอยู่แล้ว");
    return;
  }
                ...
                return (
                  ...
                  >
                    <div className="package-card-top">
                      {plan.recommended && (!user || currentPlan === "basic") && (
