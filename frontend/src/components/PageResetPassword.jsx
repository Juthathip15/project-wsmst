  ...
  return (
    <div className="page-reset-password">
      <div className="container-reset-password">
        ...
        <h2 className="title-reset-password">รีเซ็ตรหัสผ่านใหม่</h2>
        ...
        <div className="input-group-reset-password">
          ...
          />
          {errors.email && <span className="error-reset-password">{errors.email}</span>}
        </div>

        {/* New Password */}
        <div className="input-group-reset-password">
          <label>รหัสผ่านใหม่</label>
          <div className="password-wrapper-reset-password">
            <input
            ...
            />
            <button
              className="eye-btn-reset-password"
          ...
          {errors.newPassword && (
            <span className="error-reset-password">{errors.newPassword}</span>
          )}
        </div>
        ...
        <div className="input-group-reset-password">
          ...
          {errors.confirmPassword && (
            <span className="error-reset-password">{errors.confirmPassword}</span>
          )}
        </div>
        ...
        {/* Button */}
        <button className="btn-reset-password" onClick={handleSubmit}>
          รีเซ็ตรหัสผ่านใหม่
        </button>
